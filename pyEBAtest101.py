...
for entity in Z:
    ...
    if shortfallB10>0.0:
        ...
        print Bank_name[entity],Country_code[entity]
        print entity
        for label in [993441,993603,993402,993501,993601,993434,993502,993602]  :
            ...
            for line in lines:
                print line
        CET1      = float(S[993434][201612][3])
        shortfallB10 = max(float(S[993434][201612][3])*5.5/100.0 - float(S[993402][201612][3]) ,0.0)
        print ' '
        print 'Common EU wide CET1 Threshold (5.5%)\t\t' + str(CET1*5.5/100.0)
        print '   based on risk exposure of \t\t\t' + str(CET1)
        
        print'B10	to threshold of 5.5% in Adverse Scenario \t' + str(shortfallB10) 
        print'B10	in bp  \t\t\t\t' + str(float( 10000.0*(shortfallB10)/CET1  ) )
        
    
        
        try:
            print 'B10 from ECB CA-DISCLOUSURE ', LEI2ECB[entity],'\t\t', ECB[LEI2ECB[entity]].B10
        except:
            print entity
        print
        print ' ------------------------------- '
